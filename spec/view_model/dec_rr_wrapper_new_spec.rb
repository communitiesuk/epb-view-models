...
RSpec.describe ViewModel::DecRrWrapper do
  context "when calling the DEC-RR wrapper for a valid schema" do
    it "returns the expected assertion for the to_hash method", :aggregate_failures do
      schema_tests = [
        { schema: "DECAR-S-8.0.0", type: "dec-ar", method_called: :to_hash },
    ...
    it "returns the expected assertion for the to_report method", :aggregate_failures do
      schema_tests = [
        { schema: "CEPC-NI-8.0.0", type: "dec-rr", method_called: :to_report },
        { schema: "CEPC-7.1", type: "dec-rr-ni", method_called: :to_report },
        { schema: "CEPC-7.0", type: "dec-rr-ni", method_called: :to_report },
        { schema: "CEPC-6.0", type: "dec-rr-ni", method_called: :to_report },
        { schema: "CEPC-5.1", type: "dec-rr-ni", method_called: :to_report },
        { schema: "CEPC-5.0", type: "dec-rr-ni", method_called: :to_report },
        { schema: "CEPC-4.0", type: "dec-rr-ni", method_called: :to_report },
        { schema: "CEPC-3.1", type: "dec-rr-ni", method_called: :to_report },
      ]
    ...
    it "returns the expected assertion for the to_certificate_summary method", :aggregate_failures do
      schema_tests = [
        { schema: "DECAR-S-8.0.0", type: "dec-ar", method_called: :to_certificate_summary },
