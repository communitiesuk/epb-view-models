...
RSpec.describe ViewModel::SapWrapper do
  ...
  context "when general schemas are parsed" do
      ...
      let(:assertion) do
        {
          ...
          mech_vent_sys_index_number: 500_249,
    ...
    describe ".to_domestic_digest" do
      let(:schemas) do
        ...
        is_142 = {
          different_fields: {
            ...
            main_heating_controls: %w[Thermostat],
          },
        }
        ...
        [
          ...
          { schema: "SAP-Schema-16.3", type: "rdsap" }.deep_merge(is_rdsap),
          { schema: "SAP-Schema-16.2", type: "sap" }.deep_merge(is_162),
          { schema: "SAP-Schema-16.2", type: "rdsap" }.deep_merge(is_rdsap),
          { schema: "SAP-Schema-16.1", type: "sap" }.deep_merge(is_162),
          { schema: "SAP-Schema-16.1", type: "rdsap" }.deep_merge(is_rdsap),
          { schema: "SAP-Schema-16.0", type: "sap" }.deep_merge(is_162),
          { schema: "SAP-Schema-16.0", type: "rdsap" }.deep_merge(is_rdsap),
          { schema: "SAP-Schema-15.0", type: "sap" }.deep_merge(is_pre_16),
          { schema: "SAP-Schema-15.0", type: "rdsap" }.deep_merge(is_150),
          ...
          { schema: "SAP-Schema-13.0", type: "rdsap" }.deep_merge(is_rdsap_130),
          ...
          { schema: "SAP-Schema-10.2", type: "rdsap" }.deep_merge(is_rdsap_112),
        ]
      end
      ...
      it "reads the appropriate values", :aggregate_failures do
