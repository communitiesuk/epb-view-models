  ...
  context "when calling the RdSAP wrapper for a valid schema" do
    it "returns the expected assertion for the to_hash method", :aggregate_failures do
      schema_tests = [
        ...
        { schema: "RdSAP-Schema-S-22.0.0", type: "epc", method_called: :to_hash },
        { schema: "RdSAP-Schema-S-21.0", type: "epc", method_called: :to_hash },
        { schema: "RdSAP-Schema-S-19.0", type: "epc", method_called: :to_hash },
        { schema: "RdSAP-Schema-S-18.0", type: "epc", method_called: :to_hash },
        { schema: "RdSAP-Schema-S-17.00", type: "epc", method_called: :to_hash },
        { schema: "RdSAP-Schema-S-16.1", type: "epc", method_called: :to_hash },
        { schema: "RdSAP-Schema-S-16.1", type: "epc_2", method_called: :to_hash },
        { schema: "RdSAP-Schema-S-15.0", type: "epc", method_called: :to_hash },
        { schema: "RdSAP-Schema-S-14.0", type: "epc", method_called: :to_hash },
        { schema: "RdSAP-Schema-S-12.0", type: "epc", method_called: :to_hash },
      ]
    ...
    it "returns the expected assertion for the to_certificate_summary method", :aggregate_failures do
      schema_tests = [
        ...
        { schema: "RdSAP-Schema-S-22.0.0", type: "epc", method_called: :to_certificate_summary },
        ...
        { schema: "RdSAP-Schema-S-18.0", type: "epc", method_called: :to_certificate_summary },
        { schema: "RdSAP-Schema-S-17.00", type: "epc", method_called: :to_certificate_summary },
        { schema: "RdSAP-Schema-S-16.1", type: "epc", method_called: :to_certificate_summary },
        { schema: "RdSAP-Schema-S-15.0", type: "epc", method_called: :to_certificate_summary },
      ]
