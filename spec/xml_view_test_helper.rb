def test_xml_doc(schemas, assertion, method_called = :to_hash, additional_data = {})
  schemas.each do |schema_case|
    ...
    view_model = ViewModel::Factory.new.create(sample, schema_case[:schema], nil, additional_data)
